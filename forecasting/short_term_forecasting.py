...
from configuration.configuration_database import local_database
from configuration.configuration_database import history_database
from sqlalchemy import create_engine, and_  # Import database
from sqlalchemy.orm import sessionmaker

import forecasting.forecasting_AC as f_AC
import forecasting.forecasting_PV as f_PV


db_str = history_database["db_str"]
...
def short_term_forecasting_pv_history(*args):
    ...
    timePV = int((Target_Time - default_time["Base_time"]) / default_time["Time_step_opf"])
    print(timePV)
    PV_PG = f_PV.forecastingPV(timePV,PVmodel)
...
def short_term_forecasting_load_ac_history(*args):
    ...
    #     TIME_STAMP=int((Target_Time - default_time["Base_time"]) / default_time["Time_step_opf"])).first()
    print('..................time stamp..............................................')
    timeAC = int((Target_Time - default_time["Base_time"]) / default_time["Time_step_opf"])
    print(timeAC)
