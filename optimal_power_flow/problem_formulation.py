...
class problem_formulation():
    ...
    #     Aeq_compact = zeros((neq,  NX))
    #     beq_compact = zeros(neq)
    #     Aineq_compact = zeros((nineq,  NX))
    #     bineq_compact = zeros(nineq)
    #     c_compact = zeros(NX)
    #
    ...
    #     lb = numpy.append(local_model_mathematical["lb"])
    #     ub = numpy.append(local_model_mathematical["ub"])
    #
    #     Aeq_compact_temp = zeros(NX)
    ...
    #              "lb": lb,
    #              "ub": ub}
        return local_model_mathematical
